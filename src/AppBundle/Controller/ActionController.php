...
class ActionController extends Controller
{
     ...
     *
     * @Route("/", name="admin_gestion_action_index")
     * @Method("GET")
     */
     ...
     *
     * @Route("/new", name="admin_gestion_action_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_gestion_action_show', array('id' => $action->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_gestion_action_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="admin_gestion_action_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Action $action)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_gestion_action_edit', array('id' => $action->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_gestion_action_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Action $action)
    {
        ...
        return $this->redirectToRoute('admin_gestion_action_index');
    }
    ...
    private function createDeleteForm(Action $action)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_gestion_action_delete', array('id' => $action->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
