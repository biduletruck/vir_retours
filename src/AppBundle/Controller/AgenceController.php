...
class AgenceController extends Controller
{
     ...
     *
     * @Route("/", name="admin_gestion_agence_index")
     * @Method("GET")
     */
     ...
     *
     * @Route("/new", name="admin_gestion_agence_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_gestion_agence_show', array('id' => $agence->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_gestion_agence_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="admin_gestion_agence_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Agence $agence)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_gestion_agence_edit', array('id' => $agence->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_gestion_agence_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Agence $agence)
    {
        ...
        return $this->redirectToRoute('admin_gestion_agence_index');
    }
    ...
    private function createDeleteForm(Agence $agence)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_gestion_agence_delete', array('id' => $agence->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
