 ...
 *
 * @Route("admin/gestion/emplacement")
 */
class EmplacementController extends Controller
{
     ...
     *
     * @Route("/", name="admin_gestion_emplacement_index")
     * @Method("GET")
     */
     ...
     *
     * @Route("/new", name="admin_gestion_emplacement_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_gestion_emplacement_show', array('id' => $emplacement->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_gestion_emplacement_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="admin_gestion_emplacement_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Emplacement $emplacement)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_gestion_emplacement_edit', array('id' => $emplacement->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_gestion_emplacement_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Emplacement $emplacement)
    {
        ...
        return $this->redirectToRoute('admin_gestion_emplacement_index');
    }
    ...
    private function createDeleteForm(Emplacement $emplacement)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_gestion_emplacement_delete', array('id' => $emplacement->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
